...
savebtn.addEventListener('click', function () {
    ...
    let noteTitle = document.getElementById('noteTitle');//notetitle.
    ...
    if (noteTitle.value == "" || notetxt.value == "") {
        ...
        //here it will push the NotesdataObj in note obj.
        notesObj.push(NotesdataObj);
        //converting the json object to string and saving it into localstorage.
        localStorage.setItem('notes', JSON.stringify(notesObj));
        //setting the noteTitle and notetext value to empty.
        notetxt.value = "";
        noteTitle.value = "";
...
function showNotes() {
    ...
    notesObj.forEach(function (element, index) {
        ...
        html += `
        <div class="card">
        <p class="heading" id="noteHeading">${index + 1}.${element.title}</p>
        <p class="content" id="noteContent">${element.notetxt}</p>
